...
<div class="<?php echo $custom_css; ?> o-iprogram__wrapper o-iprogram">
    ...
    <div class="o-iprogram__swiper-button-prev">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/arrow-to-right.svg" alt="arrow">
    </div>
    <div class="o-iprogram__swiper-button-next">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/arrow-to-right.svg" alt="arrow">
    </div>
